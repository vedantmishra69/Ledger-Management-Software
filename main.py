...
class Daily_Entry_Frame(tk.Frame):
    def __init__(self, container, controller):
        ...
        self.lbl_item_weight = ttk.Label(interior, text="Quantity")
        ...
        self.lbl_item_rate = ttk.Label(interior, text="Total")
        ...
        self.ent_item_quant = ttk.Entry(interior)
        ...
        self.ent_item_total = ttk.Entry(interior)
    ...
    def sum_items(self):
        ...
        for name, quant, weight, rate, total in self.ent_list:
            ...
            quant_num = weight_num = rate_num = total_num = 0
